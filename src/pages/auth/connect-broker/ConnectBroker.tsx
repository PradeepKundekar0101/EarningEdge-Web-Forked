          ...
          <div className="bg-darkBg border-[0.4px] border-darkStroke p-8 rounded-lg shadow-md w-full max-w-md">
            ...
            <form onSubmit={handleConnect}>
              ...
              <div>
                <button
                  type="submit"
                  className="w-full bg-green-700 mt-2 text-white py-2 px-4 rounded-md hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2"
                  disabled={isPending}
                >
                ...
                <button
                  ...
                  type="button"
                  className="text-green-400 mt-2 bg-darkSecondary border-darkStroke border-[0.5px] rounded-md w-full py-2 px-4 text-center"
                >
                  Need Help?
                </button>
              </div>
