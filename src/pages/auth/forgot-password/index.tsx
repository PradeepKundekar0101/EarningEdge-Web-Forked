        ...
        <div className="flex flex-col text-white gap-3 mb-10 z-10 w-full md:w-[30%]">
          ...
          {step === 1 && (
            <>
              ...
              />
              <button
                className={`text-xl rounded-md font-semibold ${isSendingOtp ? 'bg-gray-400' : 'bg-white'} text-black p-3 flex justify-center items-center`}
          ...
          {step === 2 && (
            <>
              ...
              />
              <button
                className={`text-xl rounded-md font-semibold ${isResettingPassword ? 'bg-gray-400' : 'bg-white'} text-black p-3 flex justify-center items-center`}
